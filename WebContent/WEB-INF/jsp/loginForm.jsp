...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="loginForm"
				style="font-size: 22px; color: #FFF;"> 智能空间服务<font color="#FFCC00">ISS</font><span
		...
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx}/js/metronic/img/profile/log3.jpg" alt="">
				<div class="page-lock-info">
					<span>&nbsp;</span> 
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px">姓名+学号登录</span>
						</c:when>
						<c:otherwise>
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									placeholder="密码" id="eduid" name="eduid"
									value="${eduid}">
							</div>
						</div>
					</div>
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2019 @ 山东大学控制学院服务机器人实验室
			</div>
		</form>
	</div>

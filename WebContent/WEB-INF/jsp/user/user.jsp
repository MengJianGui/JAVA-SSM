	 	  ...
	 	  /** 给数据行绑定鼠标覆盖以及鼠标移开事件  */
	 	   ...
	 	   $("#delete").click(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   $.ligerDialog.error("请选择一个需要删除的成员！");
	 		   }else{
	 			   /** 得到用户选中的所有的需要删除的ids */
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除成员",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：成员管理 &gt; 成员查询</td>
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="userform" method="post" id="userform" action="${ctx}/user/selectUser">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	姓名：<input type="text" name="name">
					    	学号：<input type="text" name="eduid">
					    	导师：<select  name="tutor_id" style="width:110px;">

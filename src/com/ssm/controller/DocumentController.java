	...
	@RequestMapping(value="/document/addDocument")
	 public ModelAndView addDocument(
		...
		if(flag.equals("1")){
			...
			String path1 = "C:\\Users\\Administrator\\Documents\\eclipse-workspace\\ssm_hrm\\WebContent\\upload\\";
			 // 将上传文件保存到一个目标文件当中
			document.getFile().transferTo(new File(path1+File.separator+ fileName));
